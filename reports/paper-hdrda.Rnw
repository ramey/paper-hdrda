...
data set, our proposed methods outperformed the other classifiers considered.
Additionally, the \emph{HDRDA} classifiers had comparable performance on five of
the six data sets.
