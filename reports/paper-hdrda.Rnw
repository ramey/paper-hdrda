...
$y_i \in \{\omega_1, \ldots, \omega_K\}$. We assume that $(\bm x_i, y_i)$ is a
...
function of the $k$th class and $p(\omega_k)$ is the prior probability of class
membership of the $k$th class. We further assume that each of $p(\omega_k)$ is
equal, $k = 1, \ldots, K$.
