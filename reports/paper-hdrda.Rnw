...
over 250 random training-test partitions in Table \ref{tab:microarray-results}
...
table_caption <- 'The average of the test error rates obtained on gene-expression data sets over 250 random training-test partitions. Standard deviations of the test error rates are given in the parentheses.'
