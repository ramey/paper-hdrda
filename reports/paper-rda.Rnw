...
\caption{Averages of the 1000 error-rate estimates of the competing classifiers
  ...
  Dudoit (circle), Guo (triangle), Pang (square), Tong = (cross), Witten (
  square with X), and ours (asterisk). Approximate standard errors are no
  greater than $\Sexpr{gsub('.', '\\cdot', round(max_se, 3), fixed = TRUE)}$.}
